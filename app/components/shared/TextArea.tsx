...
const textArea = {
  ...
  input: {
    base: "placeholder-gray-300 shadow-sm focus:ring-gray-500 focus:border-gray-500 block w-full sm:text-sm border-gray-300 rounded-md",
    icon: "pr-9",
  },
  helperText: {
...
const TextField = forwardRef<HTMLTextAreaElement, TextAreaProps>(
  function TextField(props: TextAreaProps, ref) {
    const {
      valid,
      disabled,
      label,
    ...
    const textAreaStyle = overrideTailwindClasses(
      clsx(textArea.input.base, className)
    );
